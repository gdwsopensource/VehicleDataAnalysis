 ...
 *
 * Create Time: 2017年6月20日 下午6:09:06
 */
package com.gdws.vehicle.conf;
 ...
 * @version 1.0, 2017年6月20日 下午6:09:06
 */
@Configuration
@EnableTransactionManagement
@EnableConfigurationProperties(DataSourceProperties.class)
@MapperScan("com.gdws.vehicle.mapper")
public class DataSourceConfig {
    ...
    public SqlSessionFactory sqlSessionFactory() throws Exception {
        ...
        sqlSessionFactoryBean.setTypeAliasesPackage("com.gdws.vehicle.model");
